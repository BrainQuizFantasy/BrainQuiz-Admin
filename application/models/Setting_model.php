...
class Setting_model extends CI_Model {
    ...
    public function update_ads() {
        $settings = [
            ...
            'android_game_id','ios_game_id','daily_ads_visibility','daily_ads_coins','daily_ads_counter'
        ];
    ...
    public function update_web_home_settings(){
        ...
        $settings = [
            'section1_heading','section1_cover_image','section1_title1','section1_title2','section1_title3','section1_image_title_title1','section1_image_title_title2','section1_image_title_title3','section1_image_title_title4','section1_image_title_image1','section1_image_title_image2','section1_image_title_image3','section1_image_title_image4',
            'section2_heading','section2_cover_image','section2_title_desc_title1','section2_title_desc_title2','section2_title_desc_title3','section2_title_desc_title4','section2_title_desc_desc1','section2_title_desc_desc2','section2_title_desc_desc3','section2_title_desc_desc4',
            'section3_heading','section3_title_image_desc_title1','section3_title_image_desc_title2','section3_title_image_desc_title3','section3_title_image_desc_title4','section3_title_image_desc_image1','section3_title_image_desc_image2','section3_title_image_desc_image3','section3_title_image_desc_image4','section3_title_image_desc_desc1','section3_title_image_desc_desc2','section3_title_image_desc_desc3','section3_title_image_desc_desc4'
        ];
        ...
        foreach ($settings as $type) {
            ...
            if ($res) {
                ...
                if (isset($_FILES[$type]) && !empty($_FILES[$type]['name'])){
                    ...
                    // array of all images
                    $images = ['section1_cover_image','section1_image_title_image1','section1_image_title_image2','section1_image_title_image3','section1_image_title_image4','section2_cover_image','section3_title_image_desc_image1','section3_title_image_desc_image2','section3_title_image_desc_image3','section3_title_image_desc_image4'];
