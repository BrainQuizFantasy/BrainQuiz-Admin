...
<html lang="en">
    ...
    <body >
        <div class="login" style="background-image: url(<?= isset($background_file['message']) && !empty($background_file['message']) ? base_url() . LOGO_IMG_PATH . $background_file['message'] : base_url() . LOGO_IMG_PATH .'background-image-stock.jpg'; ?>);">
            <div class="overlay">
                <div id="app">
